...
function Lunar.API:CanFly()
	...
	if (not Lunar.API.flyzonePandaria) then
		Lunar.API.flyzoneKalimdor = { C_Map.GetMapChildrenInfo(1) } ;
		Lunar.API.flyzoneEasternKingdom = { C_Map.GetMapChildrenInfo(2) } ;
		Lunar.API.flyzoneOutland = { C_Map.GetMapChildrenInfo(3) } ;
		Lunar.API.flyzoneNorthrend = { C_Map.GetMapChildrenInfo(4) } ;
		Lunar.API.flyzonePandaria = { C_Map.GetMapChildrenInfo(6) } ;
		Lunar.API.flyzoneDraenor = { C_Map.GetMapChildrenInfo(7) } ;
	end
